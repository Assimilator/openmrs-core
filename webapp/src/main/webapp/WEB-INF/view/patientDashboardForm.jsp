...
<div id="patientSections">
	...
	<openmrs:hasPrivilege privilege="Patient Dashboard - View Regimen Section">	
		<div id="patientRegimen" style="display:none;">
			...
			<openmrs:portlet url="patientRegimen" id="patientDashboardRegimen" patientId="${patient.patientId}" parameters="displayDrugSetIds=${displayDrugSetIds},*|displayFutureRegimens=true" />
