...
<div id="regimenPortlet">
				...
				<table width="100%" class="patientRegimenTable">
					<tr class="patientRegimenRow">
						<c:if test="${not empty model.standardRegimens}">
							<td valign="top" class="patientRegimeData" style="width:40%; display:none">								
						...
						<td valign="top" align="right" class="patientRegimeDataFlexible">
							<div id="regimenPortletAddFlexible">
								...
								<table class="patientAddFlexibleTable" style="width:100%;">
									...
									<tr class="patientAddFlexibleRow">
										<td class="patientAddFlexibleData" style="width:20%;"><openmrs:message code="DrugOrder.drug"/></td>						
										<td class="patientAddFlexibleData">
											<!-- onChange=updateAddFields('drug','units','frequency') -->
									...
									<tr class="patientAddFlexibleRow">
										<td class="patientAddFlexibleData" style="width:20%;"><openmrs:message code="DrugOrder.frequency"/></td>
										<td class="patientAddFlexibleData">
									...
									<tr class="patientAddFlexibleRow">
										<td class="patientAddFlexibleData" style="width:20%;">Quantity</td>
										<td>
									...
									<tr class="patientAddFlexibleDateRow">
										<td class="patientAddFlexibleDate" style="width:20%;"><openmrs:message code="general.dateStart"/></td>
										<td class="patientAddFlexibleDate">
											<openmrs:fieldGen type="java.util.Date" formFieldName="startDate" val="" parameters="noBind=true" />
										</td>
									</tr>
									<tr class="patientAddFlexibleRow">
									<td class="patientAddFlexibleDate" style="width:20%;"> Duration </td>
										<td class="patientAddFlexibleData">
									...
									<tr class="patientAddFlexibleRow">
										<td class="patientAddFlexibleDate" style="width:20%;"><openmrs:message code="general.instructions"/></td>
										<td class="patientAddFlexibleData">
											<openmrs:fieldGen type="java.lang.String" formFieldName="instructions" val="" parameters="noBind=true" />
										</td>
									</tr>
									
									<tr class="patientAddFlexibleRow" style="display:none;">
									...
									<tr class="patientAddFlexibleButtonRow">
										<td colspan="2" align="center" class="patientAddFlexibleButtonData">
											...
											<span id="addNew"><input type="button" value="<openmrs:message code="general.add" />" onClick="handleAddDrugOrder(${model.patientId}, 'drug', 'dose', 'units', 'frequencyDay', 'quantity', 'startDate', 'instructions');"></span>
											<span id="cancelNew"><input type="button" value="<openmrs:message code="general.cancel" />" onClick="cancelNewOrder();"></span>
										</td>
									</tr>
								</table>
								</form>
	...
	<script>
		...
		function cancelNewOrder() {
			...
			showHideDiv('regimenPortletAddForm');
			//hideDiv("addNew");
			//hideDiv("actionNew");
			//hideDiv("reasNew");
			//hideDiv("replaceNew");
